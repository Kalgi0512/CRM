...
import { X, User, Mail, Lock, ChevronDown, Check, Eye, EyeOff } from 'lucide-react';
                        ...
                        <div className="relative">
                          ...
                          >
                            ...
                            <input
                              ...
                              className={`pl-12 w-full py-3 rounded-xl border-2 transition-all duration-300 bg-white/80 backdrop-blur-sm ${errors.name
                        ...
                        <div className="relative">
                          ...
                          >
                            ...
                            <input
                              ...
                              onBlur={() => setFocusedField(null)}
                              className={`pl-12 w-full py-3 rounded-xl border-2 transition-all duration-300 bg-white/80 backdrop-blur-sm ${errors.email
                                  ? 'border-red-300 focus:border-red-500 focus:ring-red-200'
                                  : 'border-gray-200 focus:border-[var(--color-secondary)] focus:ring-[var(--color-secondary)]/20'
                                } focus:ring-4 focus:outline-none placeholder-gray-400`}
