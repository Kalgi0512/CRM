      ...
      >   
        <div className="z-10 text-center space-y-4 max-w-lg">
          ...
          >
            ...
            />
            <div className="absolute -inset-4 bg-gradient-to-r from-blue-400/20 to-indigo-400/20 rounded-full blur-3xl" />
          </motion.div>
          ...
          >
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <motion.button
                ...
                type="submit"
                disabled={isLoading}
                className="w-full flex justify-center items-center gap-3 py-3 px-6 bg-gradient-primary text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] group disabled:opacity-80 disabled:cursor-not-allowed cursor-pointer"
                whileHover={{ 
                  scale: 1.02,
